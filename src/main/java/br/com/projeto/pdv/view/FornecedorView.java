 ...
 * @author Lex
 */
public class FornecedorView extends JDialog {
    ...
    public void listar() {
        ...
        List<FornecedorModel> lista = fDao.listarFornecedor();
    ...
    private void initComponents() {
        ...
        btnAtualizarListaFuncionarios = new javax.swing.JButton();
        ...
        TabelaFornecedores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod:", "Nome:", "CNPJ:", "E-Mail:", "Tel.:", "Cel.:", "Cep:", "End.:", "Nº", "Bairro:", "Comp.:", "Cidade:", "UF:"
            }
        ));
        ...
        if (TabelaFornecedores.getColumnModel().getColumnCount() > 0) {
            TabelaFornecedores.getColumnModel().getColumn(0).setPreferredWidth(35);
            TabelaFornecedores.getColumnModel().getColumn(1).setPreferredWidth(120);
            TabelaFornecedores.getColumnModel().getColumn(8).setPreferredWidth(25);
            TabelaFornecedores.getColumnModel().getColumn(10).setPreferredWidth(40);
            TabelaFornecedores.getColumnModel().getColumn(12).setPreferredWidth(35);
        }

        btnAtualizarListaFuncionarios.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        btnAtualizarListaFuncionarios.setText("ATUALIZAR LISTA DE FORNECEDORES");
        btnAtualizarListaFuncionarios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAtualizarListaFuncionariosActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(167, 167, 167)
                        .addComponent(btnAtualizarListaFuncionarios))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtCnpj, javax.swing.GroupLayout.DEFAULT_SIZE, 142, Short.MAX_VALUE)
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        listar();
        limpar();
        Utilitarios.setCellsAlignment(TabelaFornecedores, SwingConstants.CENTER);
    ...
    private void TabelaFornecedoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaFornecedoresMouseClicked
        ...
        cbxUf.setSelectedItem(TabelaFornecedores.getValueAt(TabelaFornecedores.getSelectedRow(), 12).toString());
    ...
    private void btnPesquisarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPesquisarMouseClicked
        ...
        FornecedorDAO fDao = new FornecedorDAO();
        List<FornecedorModel> lista = fDao.listarPorNome(nome);
        DefaultTableModel dados = (DefaultTableModel) TabelaFornecedores.getModel();
        dados.setNumRows(0);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (txtCodigo.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Erro. Selecione um Fornecedor para excluir!");
        } else {
            int op = JOptionPane.showConfirmDialog(null, "Deseja Realmente excluir o Fornecedor selecionado?",
                    "Excluir Fornecedor", JOptionPane.YES_NO_OPTION );
            if (op != 2 && op != -1) {
                if (op == 0) {
                    obj.setId(Integer.parseInt(txtCodigo.getText()));
                    fDao.excluirFornecedor(obj);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        FornecedorDAO fDao = new FornecedorDAO();
         FornecedorModel obj = new FornecedorModel();
        if (txtCodigo.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Erro. Selecione um Fornecedor para Alterar!");
        } else {
    ...
    private void btnAtualizarListaFuncionariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarListaFuncionariosActionPerformed
        // TODO add your handling code here:
        listar();
        txtPesquisa.setText("");

    }//GEN-LAST:event_btnAtualizarListaFuncionariosActionPerformed

    private void txtCepKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCepKeyPressed
//        // TODO add your handling code here:
//        //Programacao do keypress
//        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
//            obj = fDao.buscaCep(txtCep.getText());
//
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FornecedorView.class
    ...
    private javax.swing.JButton btnAtualizarListaFuncionarios;
